...
pub enum AddrMode {
    ...
    /// If true always clock when it would otherwise depend on page cross
    AbsoluteX(bool),
...
impl Opcode {
    ...
    pub fn from_byte(byte: u8) -> Self {
        ...
        match byte {
            ...
            0xff => Opcode::new(Isc, AbsoluteX(false)),
            0xfb => Opcode::new(Isc, AbsoluteY(false)),
            0xe3 => Opcode::new(Isc, IndirectX),
            0xf3 => Opcode::new(Isc, IndirectY(false)),

            0xc7 => Opcode::new(Dcp, ZeroPage),
            0xd7 => Opcode::new(Dcp, ZeroPageX),
            0xcf => Opcode::new(Dcp, Absolute),
            0xdf => Opcode::new(Dcp, AbsoluteX(false)),
            0xdb => Opcode::new(Dcp, AbsoluteY(false)),
            0xc3 => Opcode::new(Dcp, IndirectX),
            0xd3 => Opcode::new(Dcp, IndirectY(false)),
            ...
            0x93 => Opcode::new(Sha, IndirectY(true)),
            0x9f => Opcode::new(Sha, AbsoluteY(true)),
            0x9b => Opcode::new(Shs, AbsoluteY(true)),
            0x9c => Opcode::new(Shy, AbsoluteX(false)),
            0x9e => Opcode::new(Shx, AbsoluteY(true)),
            ...
            0x3d => Opcode::new(And, AbsoluteX(false)),
            0x39 => Opcode::new(And, AbsoluteY(false)),
            0x21 => Opcode::new(And, IndirectX),
            0x31 => Opcode::new(And, IndirectY(false)),
            ...
            0x5d => Opcode::new(Eor, AbsoluteX(false)),
            0x59 => Opcode::new(Eor, AbsoluteY(false)),
            0x41 => Opcode::new(Eor, IndirectX),
            0x51 => Opcode::new(Eor, IndirectY(false)),

            0x09 => Opcode::new(Ora, Immediate),
            0x05 => Opcode::new(Ora, ZeroPage),
            0x15 => Opcode::new(Ora, ZeroPageX),
            0x0d => Opcode::new(Ora, Absolute),
            0x1d => Opcode::new(Ora, AbsoluteX(false)),
            0x19 => Opcode::new(Ora, AbsoluteY(false)),
            0x01 => Opcode::new(Ora, IndirectX),
            0x11 => Opcode::new(Ora, IndirectY(false)),
            ...
            0xdd => Opcode::new(Cmp, AbsoluteX(false)),
            0xd9 => Opcode::new(Cmp, AbsoluteY(false)),
            0xc1 => Opcode::new(Cmp, IndirectX),
            0xd1 => Opcode::new(Cmp, IndirectY(false)),
            ...
            0x1c | 0x3c | 0x5c | 0x7c | 0xdc | 0xfc => Opcode::new(Nop, AbsoluteX(false)),
